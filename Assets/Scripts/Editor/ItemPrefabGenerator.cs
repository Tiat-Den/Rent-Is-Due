...
namespace RentIsDue.Editor
{
    public class ItemPrefabGenerator
    {
        ...
        public static void GenerateAllItemPrefabs()
        {
            ...
            // Bản đồ ghép nối Model 3D chuẩn xác và phóng to 2.5x cho từng vật phẩm
            var modelMapping = new Dictionary<string, (string fbx, float scale, System.Action<GameObject> customBuilder)>
            {
                // 1. Chai nhựa (Plastic Bottle) -> Thân chai xanh + Nắp trắng (Phóng to 2.5x)
                { "item_plastic_bottle", (null, 1f, root => BuildBottle(root, new Color(0.2f, 0.7f, 0.9f, 0.8f))) },
                
                // 2. Lon nhôm (Aluminum Can) -> Vỏ lon nước ngọt đỏ/bạc (Phóng to 2.5x)
                ...
                // Các đồ công nghệ & nội thất dùng FBX chuẩn từ Kenney (Tăng kích thước 2.5x):
                { "item_old_newspaper", ("books.fbx", 0.52f, null) },
                { "item_old_book", ("books.fbx", 0.55f, null) },
                { "item_magazine_bundle", ("books.fbx", 0.60f, null) },
                { "item_cardboard_box", ("cardboardBoxClosed.fbx", 0.80f, null) },
                { "item_old_clothes", ("pillow.fbx", 0.65f, null) },
                { "item_rubber_duck", ("bear.fbx", 0.50f, null) },
                { "item_frying_pan", ("toaster.fbx", 0.55f, null) },
                { "item_wall_clock", ("lampSquareCeiling.fbx", 0.55f, null) },
                { "item_keyboard", ("computerKeyboard.fbx", 0.65f, null) },
                { "item_mouse", ("computerMouse.fbx", 0.40f, null) },
                { "item_headphones", ("speakerSmall.fbx", 0.50f, null) },
                { "item_game_controller", ("computerMouse.fbx", 0.50f, null) },
                { "item_old_gpu", ("computerKeyboard.fbx", 0.55f, null) },
                { "item_broken_laptop", ("laptop.fbx", 0.60f, null) },
                { "item_digital_camera", ("speakerSmall.fbx", 0.50f, null) },
                { "item_vintage_radio", ("radio.fbx", 0.62f, null) },
                { "item_old_console", ("televisionVintage.fbx", 0.70f, null) },
                { "item_vinyl_player", ("speaker.fbx", 0.70f, null) },
                { "item_antique_clock", ("lampRoundTable.fbx", 0.55f, null) },
                { "item_vintage_camera", ("speakerSmall.fbx", 0.55f, null) },
                { "item_rare_painting", ("televisionModern.fbx", 0.75f, null) },
                { "item_rare_console", ("televisionModern.fbx", 0.70f, null) },
                { "item_rare_coin_collection", ("cardboardBoxOpen.fbx", 0.55f, null) }
            };
            ...
            foreach (var guid in guids)
            {
                ...
                else
                {
                    ...
                    if (fbxAsset != null)
                    {
                        ...
                        modelInstance.transform.SetParent(rootObj.transform, false);
                        modelInstance.transform.localPosition = Vector3.zero;
                        modelInstance.transform.localScale = Vector3.one * 0.50f;
                    }
                }

                // Gắn Collider rộng rãi cho việc nhặt đồ từ tầm mắt cao
                BoxCollider col = rootObj.AddComponent<BoxCollider>();
                col.size = new Vector3(0.9f, 0.8f, 0.9f);
            ...
            EditorUtility.DisplayDialog("3D Items Generated!", $"Successfully generated 2.5x scaled 3D Prefabs for {generatedCount} items!", "Great!");
            Debug.Log($"<color=green>[ItemPrefabGenerator] Generated 2.5x scaled 3D Prefabs for {generatedCount} items!</color>");
        }

        // ==================== HÀM TẠO MODEL THỦ CÔNG CHÍNH XÁC (2.5x SCALE) ====================
        ...
        private static void BuildBottle(GameObject parent, Color liquidColor)
        {
            ...
            body.transform.localPosition = new Vector3(0, 0.22f, 0);
            body.transform.localScale = new Vector3(0.20f, 0.22f, 0.20f);
            ...
            neck.transform.localPosition = new Vector3(0, 0.48f, 0);
            neck.transform.localScale = new Vector3(0.09f, 0.07f, 0.09f);
            ...
            cap.transform.localPosition = new Vector3(0, 0.56f, 0);
            cap.transform.localScale = new Vector3(0.10f, 0.025f, 0.10f);
        ...
        private static void BuildSodaCan(GameObject parent, Color canColor)
        {
            ...
            can.transform.localPosition = new Vector3(0, 0.18f, 0);
            can.transform.localScale = new Vector3(0.18f, 0.18f, 0.18f);
            ...
            top.transform.localPosition = new Vector3(0, 0.36f, 0);
            top.transform.localScale = new Vector3(0.16f, 0.015f, 0.16f);
        ...
        private static void BuildJar(GameObject parent)
        {
            ...
            body.transform.localScale = new Vector3(0.22f, 0.16f, 0.22f);
            ...
            lid.transform.localPosition = new Vector3(0, 0.35f, 0);
            lid.transform.localScale = new Vector3(0.24f, 0.025f, 0.24f);
        ...
        private static void BuildMug(GameObject parent, Color mugColor)
        {
            ...
            body.transform.localScale = new Vector3(0.20f, 0.15f, 0.20f);
        ...
        private static void BuildSmartphone(GameObject parent)
        {
            ...
            body.transform.SetParent(parent.transform, false);
            body.transform.localPosition = new Vector3(0, 0.015f, 0);
            body.transform.localScale = new Vector3(0.20f, 0.025f, 0.38f);
            ...
            screen.transform.localPosition = new Vector3(0, 0.028f, 0);
            screen.transform.localScale = new Vector3(0.18f, 0.005f, 0.35f);
        ...
        private static void BuildWatch(GameObject parent)
        {
            ...
            dial.transform.localPosition = new Vector3(0, 0.02f, 0);
            dial.transform.localScale = new Vector3(0.12f, 0.025f, 0.12f);
            ...
            strap.transform.localPosition = new Vector3(0, 0.012f, 0);
            strap.transform.localScale = new Vector3(0.06f, 0.015f, 0.30f);
        ...
        private static void BuildTradingCard(GameObject parent)
        {
            ...
            card.transform.localPosition = new Vector3(0, 0.005f, 0);
            card.transform.localScale = new Vector3(0.18f, 0.005f, 0.25f);
